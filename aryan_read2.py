...
import os
path = '/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/segmented_dataset/Aryan_augs_0002/'
...
for i in range (0,len(directory_contents)):
    ...
    for j in range (0,len(class_name)):
        ...
        with open(r'/mnt/fs/aryan/aryan2.csv', 'a',newline='') as f:
